...
class AGENTPARA:
    ...
    gamma= 0.99
    lamda= 0.95
    entropy= 0.001 #0.005 #0.01 #0.001 #0.005 #0.01
    mini_lr= 5e-6
    ppo_epoch = 2 #3 #4 #5 #10
...
ACTOR_PARA.gru_lr = 1e-4 #3e-4      # GRU 层的专属学习率 (通常可以设得小一些)
...
CRITIC_PARA.model_layer_dim = [128,128,128]#[256,128,64]#[128,128,128]#[256,128,64] #[[128,128,128]#[128,64,128] #[128,128,128]#[512,256,128] #[128,128,128]
