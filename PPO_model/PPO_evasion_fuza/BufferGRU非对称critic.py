...
class Buffer(object):
    ...
    def get_all_data(self):
        ...
        return (
            ...
            np.array(self.global_states, dtype=np.float32),  # <<< 新增
    ...
    def generate_sequence_batches(self, sequence_length, batch_size, advantages, returns, verbose=False):
        ...
        for i in range(n_full_batches):
            ...
            for start_idx in batch_start_indices:
                ...
                b_global_states.append(global_states_np[start_idx:end_idx])
    ...
    def store_transition(self, state, global_state, value, action, probs, reward, done, actor_hidden=None, critic_hidden=None):
        """
