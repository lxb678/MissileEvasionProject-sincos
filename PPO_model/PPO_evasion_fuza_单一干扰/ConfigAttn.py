...
class AGENTPARA:
    ...
    gamma=0.99
    lamda=0.95
    entropy= 0.005 #0.01#0.001#0.0001 #0.01 #0.001 #0.01 #0.0001 #0.001 #0.001
    mini_lr=5e-6
    ppo_epoch = 10 #5
...
ACTOR_PARA.gru_lr = 5e-5      # GRU 层的专属学习率 (通常可以设得小一些)
ACTOR_PARA.attention_lr = 1e-2 # Attention 层的专属学习率 (可以尝试设得大一些)
