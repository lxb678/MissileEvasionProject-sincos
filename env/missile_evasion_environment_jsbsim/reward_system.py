...
class RewardCalculator:
    ...
    def calculate_dense_reward(self, aircraft: Aircraft, missile: Missile,
        ...
        """
        # 1. 计算所有独立的奖励/惩罚组件
        reward_posture = self._compute_missile_posture_reward_pure_posture(missile, aircraft)
        reward_altitude = self._compute_altitude_reward(aircraft)
        reward_resource = self._compute_resource_penalty(action[4], remaining_flares, total_flares)
        ...
        # reward_resource = 0
        # reward_aspect = 0
        # reward_roll_penalty = 0
        # reward_speed_penalty = 0
