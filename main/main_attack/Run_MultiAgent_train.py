...
from Interference_code.PPO_model.PPO_launch.Config_launch import *
from Interference_code.PPO_model.PPO_launch.Hybrid_PPO_jsbsim_launch import *  # 导入我们为进攻任务简化的PPO
from Interference_code.main.main_attack.blue_random_rules import get_blue_ai_action_random
...
writer = SummaryWriter(log_dir=f'../../log/log_attack/MARL_seed{RANDOM_SEED}_{log_time}_load_{LOAD_MODELS}')
