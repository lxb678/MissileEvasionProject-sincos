...
from Interference_code.PPO_model.PPO_evasion_fuza两个导弹.PPOMLP混合架构.旧代码.Hybrid_PPO_ATTMLP全自注意力 import *
...
# ------------------- Tensorboard 设置 -------------------
model_type_str = "EntityATT_GRU" if USE_RNN_MODEL else "EntityATT_MLP" # 修改日志标识
