...
# <<< 核心修改 1: 导入新的 Bridge 环境 >>>
from Interference_code.env.missile_evasion_environment_jsbsim_fuza两个导弹.AFSim_Bridge_Env import AFSimBridgeEnv
...
print("正在连接 AFSim，请确保 AFSim 已启动并加载了场景...")
env = AFSimBridgeEnv(host='127.0.0.1', port=9000, num_missiles=2)
set_seed(env)

# 2. 指定模型路径
# <<< 请修改这里的路径为你训练好的 GRU 模型文件夹路径 >>>
model_path = r"D:\code\规避导弹项目sincos\Interference_code\test\test_evade_fuza两个导弹"
# model_path = r"D:\code\save\save_evade_fuza两个导弹\PPO_PostAttnGRU_2025-12-10_11-55-55"
